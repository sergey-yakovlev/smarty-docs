...
Настройки мультиабонемента
    Этот блок настроек позволяет определить тарифные опции, ограничивающие или расширяющие возможности использования
    единого аккаунта на нескольких устройствах.
...
Разрешить мультилогин без ограничений количества устройств и сессий
    Эта опция позволяет обойти ограничения мультиабонемента для аккаунта и использовать его на неограниченном
    количестве любых устройств с любых IP-адресов. Автоматическая привязка устройств при авторизации для таких
    аккаунтов не осуществляется.
